    ...
    <form action="<?php echo e(route('Voters.update', $Voter->id)); ?>" method="POST">
        ...
        <div class="row">
            ...
            <div class="col mb-3">
                ...
                <input type="text" name="price" class="form-control" placeholder="Price" value="<?php echo e($Voter->BSN); ?>" >
            </div>
        </div>
        <div class="row">
            <div class="col mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\bergs\Ivote\resources\views/Voter/edit.blade.php ENDPATH**/ ?>
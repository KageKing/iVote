...
<body class="font-sans">
    <div class="container mx-auto flex flex-col items-center justify-center h-screen">
        <div class="mb-8 logo-container shine">
            <img src="<?php echo e(asset('img/logo.png'), false); ?>" alt="iVote Logo" class="h-48 w-48 rounded-lg">
        </div>
        ...
        <a href="<?php echo e(route('login'), false); ?>" class="btn btn-primary btn-lg mb-2">Login</a>
        <a href="<?php echo e(route('register'), false); ?>" class="btn btn-secondary btn-lg">Register</a>
    </div>
...
<?php /**PATH C:\Users\bergs\Ivote\resources\views/welcome.blade.php ENDPATH**/ ?>